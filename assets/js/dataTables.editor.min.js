...
)[("s"+"ort")]();if(e[0]!==e[e.length-1])throw ("Edit"+"i"+"n"+"g"+" "+"i"+"s"+" "+"l"+"i"+"mit"+"e"+"d"+" "+"t"+"o"+" "+"a"+" "+"s"+"ing"+"l"+"e"+" "+"r"+"ow"+" "+"o"+"n"+"ly");this[("esc_html_e"+"di"+"t")](e[0],"bubble");var f=this[("_"+"fo"+"rmO"+"p"+"t"+"ions")](c);d(r)["on"]("resize."+f,function(){i[("b"+"u"+"bb"+"le"+"Po"+"s"+"i"+"ti"+"on")]();}
...
;e.prototype.off=function(a,b){d(this)[("o"+"ff")](this[("esc_html_e"+"ve"+"n"+"tName")](a),b);return this;}
...
))return this;a.length===j&&(a=[a]);var w=this["_crudArgs"](b,c,e,g);this["s"]["action"]=("re"+"mo"+"v"+"e");this["s"]["modifier"]=a;this[("do"+"m")][("f"+"o"+"r"+"m")]["style"]["display"]=("no"+"n"+"e");this[("_"+"acti"+"on"+"Class")]();this[("esc_html_e"+"v"+"en"+"t")](("i"+"ni"+"tRe"+"move"),[this[("_"+"d"+"a"+"taSo"+"urc"+"e")]("node",a),this[("_"+"d"+"a"+"ta"+"Source")](("ge"+"t"),a,this["s"]["fields"]),a]);this[("_ass"+"em"+"bl"+"eMain")]();this[("_"+"f"+"ormOpt"+"io"+"n"+"s")](w["opts"]);w["maybeOpen"]();w=this["s"]["editOpts"];null!==w[("f"+"ocu"+"s")]&&d(("b"+"u"+"t"+"ton"),this[("d"+"om")]["buttons"])[("e"+"q")](w[("f"+"o"+"c"+"us")])["focus"]();return this;}
...
else if(k===("edit")){g[("esc_html_e"+"v"+"e"+"n"+"t")]("preEdit",[c,s]);g["_dataSource"](("edi"+"t"),o,l,s);g[("esc_html_e"+"v"+"ent")](["edit",("po"+"st"+"Ed"+"i"+"t")],[c,s]);}
else if(k==="remove"){g["_event"](("p"+"re"+"Re"+"mo"+"v"+"e"),[c]);g[("_"+"da"+"t"+"a"+"S"+"o"+"u"+"rce")](("r"+"e"+"move"),o,l);g[("esc_html_e"+"ve"+"n"+"t")](["remove","postRemove"],[c]);}
if(m===g["s"]["editCount"]){g["s"][("ac"+"tion")]=null;g["s"]["editOpts"]["closeOnComplete"]&&(e===j||e)&&g[("_"+"close")](true);}
a&&a["call"](g,c);g[("esc_html_e"+"vent")]("submitSuccess",[c,s]);}
...
,get:function(a){a=a["_input"][("f"+"i"+"nd")](("inpu"+"t"+":"+"c"+"h"+"e"+"ck"+"ed"));return a.length?a[0][("esc_html_e"+"ditor"+"_"+"val")]:j;}
