	...
	var file_frame;
	 ...
	 jQuery('#upload_user_avatar_button').click(function( event ){
		    ...
		    // alert(attachment.url);
		      jQuery("#cmgt_user_avatar_url").val(attachment.url);
		  ...
		  jQuery('.upload_user_cover_button').click(function( event ){
		    ...
		    file_frame.on( 'select', function() {
		      ...
		      attachment = file_frame.state().get('selection').first().toJSON();
		     // alert(attachment.url);
		      jQuery("#cmgt_church_background_image").val(attachment.url);
		      $('#upload_church_cover_preview img').attr('src',attachment.url);
		      // Do something with attachment.id and/or attachment.url here
		    });
		  ...
		  jQuery('.upload_user_avatar_button').click(function( event ){
			...
			jQuery('.upload_user_app_icon_button').click(function( event ){
		    ...
		    file_frame.on( 'select', function() {
		     ...
		     // alert(attachment.url);
		      ...
		      jQuery("#cmgt_church_app_icon_image").val(attachment.url);
		      $('#upload_church_app_icon_preview img').attr('src',attachment.url);
