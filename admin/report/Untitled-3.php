				...
				<div class="form-body user_form">
					<div class="row">
						...
						<div class="col-md-3 mb-2">
							<input type="submit" name="attendance_report" Value="<?php esc_attr_e('Go','school-mgt');?>"  class="btn btn-info save_btn"/>
						</div>
					</div>
				</div>
			</form> 
...
if(empty($_POST['attendance_report']) && $active_tab == 'attendance_report')
{
	global $wpdb;
	$table_attendance = $wpdb->prefix ."cmgt_attendence";
	$table_activity = $wpdb->prefix ."cmgt_activity";
				...
				<div class="form-body user_form margin_top_15"> <!--Card Body div-->   
					<div class="row"><!--Row Div--> 
						<div class="col-md-5">
							<div class="form-group input">
								<div class="col-md-12 form-control">
									<input type="text"  class="form-control sdate" name="sdate"  value="<?php
									...
									<label class="" for="exam_id"><?php _e('Start Date','church_mgt');?></label>
								</div>	
							</div>
						</div>
						...
						<div class="col-md-5">
							<div class="form-group input">
								<div class="col-md-12 form-control">
									<input type="text"  class="form-control edate" name="edate"   value="<?php if(isset($_REQUEST['edate'])) echo $_REQUEST['edate'];else echo date("Y-m-d");?>" autocomplete="off" readonly>
									<label class="" for="exam_id"><?php _e('End Date','church_mgt');?></label>
								</div>	
							</div>
						</div>

						<div class="col-md-2">        	
							<input for="subject_id" type="submit" name="attendance_report" Value="<?php _e('Go','church_mgt');?>"   class="btn btn-success save_btn btn_height"/>
						</div>   
