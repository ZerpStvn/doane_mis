...
<h2 class="nav-tab-wrapper"><!-- NAV TAB WRAPPER MENU START-->  
    ...
    <a href="?page=cmgt-report&tab=expense_report&tab_1=datatable" class="nav-tab <?php echo esc_html($active_tab_1) == 'datatable' ? 'nav-tab-active' : ''?>">
    <?php echo esc_html__('Datatable', 'church_mgt'); ?></a>

    <a href="?page=cmgt-report&tab=expense_report&tab_1=graph" class="nav-tab <?php echo esc_html($active_tab_1) == 'graph' ? 'nav-tab-active' : ''?>">
