<?php 	
$result=get_option('cmgt_access_right_accountant');
if(isset($_POST['save_access_right']))
{
	...
	$result=update_option( 'cmgt_access_right_accountant',$role_access_right);
	wp_redirect ( admin_url() . 'admin.php?page=cmgt-access_right&tab=Accountant&message=1');
}
$access_right=get_option('cmgt_access_right_accountant');
?>	
<div class="panel panel-white main_home_page_div"><!--- PANEL WHITE DIV START -->
		<h2 class="first_hed">
			<?php esc_html_e('Accountant Access Right', 'church_mgt'); ?>
		</h2>			
		<div class="panel-body"> <!--- PANEL BODY DIV START -->
			...
			<div class="row access_right_hed">
				...
				<div class="access_right_menucroll row border_bottom_0">
					<!-- Member module code  -->
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_min_5_res width_access_label width_16_res">
							<span class="menu-label menu_left_6">
								<?php esc_html_e('Member','church_mgt');?>
							</span>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res margin_right_10px width_14_res width_16_res">
							<div class="checkbox">
								<label>
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15 width_14_res width_16_res">
							<div class="checkbox">
								<label>
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_15_min margin_left_20_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_right_10px margin_left_20_res width_14_res width_16_res">
							<div class="checkbox">
								<label>
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_right_10px margin_left_20_res width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['group']['own_data'],1);?> value="1" name="group_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15 width_14_res width_16_res">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['group']['add'],1);?> value="1" name="group_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['group']['edit'],1);?> value="1" name="group_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_15_min margin_left_20_min width_14_res width_16_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['group']['delete'],1);?> value="1" name="group_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_right_10px margin_left_min_5_res width_access_label width_16_res">
							<span class="menu-label">
								<?php esc_html_e('Ministry','church_mgt');?>
							</span>
						</div>
						
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['ministry']['own_data'],1);?> value="1" name="ministry_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15 width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['ministry']['view'],1);?> value="1" name="ministry_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['ministry']['add'],1);?> value="1" name="ministry_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['ministry']['edit'],1);?> value="1" name="ministry_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_15_min margin_left_20_min width_14_res width_16_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['ministry']['delete'],1);?> value="1" name="ministry_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['pastoral']['own_data'],1);?> value="1" name="pastoral_own_data">	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15 width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['pastoral']['view'],1);?> value="1" name="pastoral_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['pastoral']['add'],1);?> value="1" name="pastoral_add">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['pastoral']['edit'],1);?> value="1" name="pastoral_edit">	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_15_min margin_left_20_min width_14_res width_16_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['pastoral']['delete'],1);?> value="1" name="pastoral_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['attendance']['own_data'],1);?> value="1" name="attendance_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15 width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['attendance']['view'],1);?> value="1" name="attendance_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['attendance']['add'],1);?> value="1" name="attendance_add" >	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['attendance']['edit'],1);?> value="1" name="attendance_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_15_min margin_left_20_min width_14_res width_16_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['attendance']['delete'],1);?> value="1" name="attendance_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2  margin_right_10px margin_left_20_res width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['activity']['own_data'],1);?> value="1" name="activity_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15 width_14_res width_16_res">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['activity']['add'],1);?> value="1" name="activity_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['activity']['edit'],1);?> value="1" name="activity_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_15_min margin_left_20_min width_14_res width_16_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['activity']['delete'],1);?> value="1" name="activity_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['venue']['own_data'],1);?> value="1" name="venue_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15 width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['venue']['view'],1);?> value="1" name="venue_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['venue']['add'],1);?> value="1" name="venue_add" >	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['venue']['edit'],1);?> value="1" name="venue_edit">	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_15_min margin_left_20_min width_14_res width_16_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['venue']['delete'],1);?> value="1" name="venue_delete" >	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['reservation']['own_data'],1);?> value="1" name="reservation_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15 width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['reservation']['view'],1);?> value="1" name="reservation_view" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['check-in']['own_data'],1);?> value="1" name="check-in_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15 width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['check-in']['view'],1);?> value="1" name="check-in_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['check-in']['add'],1);?> value="1" name="check-in_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['check-in']['edit'],1);?> value="1" name="check-in_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_15_min margin_left_20_min width_14_res width_16_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['check-in']['delete'],1);?> value="1" name="check-in_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_right_10px margin_left_20_res width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['document']['own_data'],1);?> value="1" name="document_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15 width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['document']['view'],1);?> value="1" name="document_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['document']['add'],1);?> value="1" name="document_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['document']['edit'],1);?> value="1" name="document_edit" disabled>	              
								</label>
							</div>
						</div>									
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_15_min margin_left_20_min width_14_res width_16_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['document']['delete'],1);?> value="1" name="document_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2margin_right_10px margin_left_min_5_res width_access_label width_16_res">
							<span class="menu-label">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['sermon-list']['own_data'],1);?> value="1" name="sermon-list_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15 width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['sermon-list']['view'],1);?> value="1" name="sermon-list_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['sermon-list']['add'],1);?> value="1" name="sermon-list_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['sermon-list']['edit'],1);?> value="1" name="sermon-list_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_15_min margin_left_20_min width_14_res width_16_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['sermon-list']['delete'],1);?> value="1" name="sermon-list_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_right_10px margin_left_20_res width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['spiritual-gift']['own_data'],1);?> value="1" name="spiritual-gift_own_data">	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15 width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['spiritual-gift']['view'],1);?> value="1" name="spiritual-gift_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['spiritual-gift']['add'],1);?> value="1" name="spiritual-gift_add" >	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['spiritual-gift']['edit'],1);?> value="1" name="spiritual-gift_edit" >	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_15_min margin_left_20_min width_14_res width_16_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['spiritual-gift']['delete'],1);?> value="1" name="spiritual-gift_delete" >	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_right_10px margin_left_20_res width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['pledges']['own_data'],1);?> value="1" name="pledges_own_data">	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15 width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['pledges']['view'],1);?> value="1" name="pledges_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['pledges']['add'],1);?> value="1" name="pledges_add" >	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['pledges']['edit'],1);?> value="1" name="pledges_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_15_min margin_left_20_min width_14_res width_16_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['pledges']['delete'],1);?> value="1" name="pledges_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_right_10px margin_left_20_res width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['songs']['own_data'],1);?> value="1" name="songs_own_data">	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15 width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['songs']['view'],1);?> value="1" name="songs_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['songs']['add'],1);?> value="1" name="songs_add">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['songs']['edit'],1);?> value="1" name="songs_edit">	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_15_min margin_left_20_min width_14_res width_16_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['songs']['delete'],1);?> value="1" name="songs_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['donate']['own_data'],1);?> value="1" name="donate_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15 width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['donate']['view'],1);?> value="1" name="donate_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['donate']['add'],1);?> value="1" name="donate_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['donate']['edit'],1);?> value="1" name="donate_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_15_min margin_left_20_min width_14_res width_16_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['donate']['delete'],1);?> value="1" name="donate_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['payment']['own_data'],1);?> value="1" name="payment_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15 width_14_res width_16_res">
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['notice']['add'],1);?> value="1" name="notice_add" >	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
					...
					<!-- <div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['newsletter']['own_data'],1);?> value="1" name="newsletter_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15 width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['newsletter']['view'],1);?> value="1" name="newsletter_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['newsletter']['add'],1);?> value="1" name="newsletter_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min width_14_res width_16_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['newsletter']['edit'],1);?> value="1" name="newsletter_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_15_min margin_left_20_min width_14_res width_16_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['newsletter']['delete'],1);?> value="1" name="newsletter_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
