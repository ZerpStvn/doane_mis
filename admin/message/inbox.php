<?php 
	...
	echo $obj_message->MJ_cmgt_pagination($totlal_message,$p,$prev,$next,'page=cmgt-message&tab=inbox');
?>
							...
							foreach($message as $msg)
							{
								...
								<tr>
									...
									<td class="min_width_150_px">
										<a class="msg_color_black" href="?page=cmgt-message&tab=inbox&tab=view_message&from=inbox&id=<?php echo esc_attr($msg->message_id);?>">
											<?php
											...
											?>
											<?php if(MJ_cmgt_count_reply_item($msg->post_id)>=1)
											{ ?>
												<span class="badge badge-success pull-right"><?php echo MJ_cmgt_count_reply_item($msg->post_id);?></span>
												<?php 
											} ?>
										</a> 
									</td>
